...
Car::Car(const BackBuffer* pBackBuffer , Vec2 location , DIRECTION direction)
{
	...
	{
		m_pSprite = new Sprite("data/CarLeft.bmp", RGB(184, 61, 186));
		m_pSprite->setBackBuffer(pBackBuffer);
	}
	else	
	{
		m_pSprite = new Sprite("data/CarRight.bmp", RGB(184, 61, 186));
		m_pSprite->setBackBuffer(pBackBuffer);
	}
...
Car::Car(const BackBuffer* pBackBuffer, DIRECTION direction)
{
