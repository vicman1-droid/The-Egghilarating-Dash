...
Truck::Truck(const BackBuffer* pBackBuffer, Vec2 location, DIRECTION direction)
{
	...
	{
		m_pSprite = new Sprite("data/TruckLeft.bmp", RGB(184, 61, 186));
		m_pSprite->setBackBuffer(pBackBuffer);
	}
	else
	{
		m_pSprite = new Sprite("data/TruckRight.bmp", RGB(184, 61, 186));
		m_pSprite->setBackBuffer(pBackBuffer);
	}
...
Truck::Truck(const BackBuffer* pBackBuffer, DIRECTION direction)
{
...
bool Truck::amIColliding(Sprite* otherSprite)
{
