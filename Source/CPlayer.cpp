...
CPlayer::CPlayer(const BackBuffer *pBackBuffer)
{
	...
	m_pSprite = new Sprite("data/Player.bmp", RGB(184,61, 186));
...
void CPlayer::Move(ULONG ulDirection)
{
	...
	{
		m_pSprite->mVelocity.x = 0.25;
		m_pSprite->mPosition.x -= m_pSprite->mVelocity.x;
	...
	{
		m_pSprite->mVelocity.y = 0.25;
		m_pSprite->mPosition.y -= m_pSprite->mVelocity.y;
